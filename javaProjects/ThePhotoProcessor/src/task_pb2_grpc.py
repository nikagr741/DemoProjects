...
class TaskServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessData = channel.unary_unary(
                '/task.TaskService/ProcessData',
                request_serializer=task__pb2.Request.SerializeToString,
                response_deserializer=task__pb2.Response.FromString,
...
def add_TaskServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessData': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=task__pb2.Request.FromString,
                    response_serializer=task__pb2.Response.SerializeToString,
            ),
    }
...
class TaskService(object):
    ...
    def ProcessData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/task.TaskService/ProcessData',
            task__pb2.Request.SerializeToString,
            task__pb2.Response.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
